...
type HttpRequest struct {
	RawHeaders       *string `protobuf:"bytes,1,opt,name=raw_headers" json:"raw_headers,omitempty"`
...
type GrrMessage struct {
	...
	ResponseId *uint64 `protobuf:"varint,3,opt,name=response_id" json:"response_id,omitempty"`
	...
	AuthState *GrrMessage_AuthorizationState `protobuf:"varint,7,opt,name=auth_state,enum=GrrMessage_AuthorizationState,def=0" json:"auth_state,omitempty"`
	...
	RequireFastpoll *bool                `protobuf:"varint,11,opt,name=require_fastpoll,def=1" json:"require_fastpoll,omitempty"`
	CpuLimit        *float32             `protobuf:"fixed32,12,opt,name=cpu_limit,def=3600" json:"cpu_limit,omitempty"`
	ArgsAge         *uint64              `protobuf:"varint,13,opt,name=args_age" json:"args_age,omitempty"`
	// The rdfvalue class of the args.
	ArgsRdfName *string `protobuf:"bytes,14,opt,name=args_rdf_name" json:"args_rdf_name,omitempty"`
	// The id of this message in the scheduler.
	TaskId *uint64 `protobuf:"varint,15,opt,name=task_id" json:"task_id,omitempty"`
	// The ttl used in the task scheduler.
	TaskTtl *int32  `protobuf:"varint,16,opt,name=task_ttl,def=7" json:"task_ttl,omitempty"`
	...
	LastLease         *string `protobuf:"bytes,19,opt,name=last_lease" json:"last_lease,omitempty"`
	NetworkBytesLimit *uint64 `protobuf:"varint,21,opt,name=network_bytes_limit,def=10737418240" json:"network_bytes_limit,omitempty"`
	XXX_unrecognized  []byte  `json:"-"`
}
...
type SignedMessageList struct {
	...
	MessageList []byte  `protobuf:"bytes,1,opt,name=message_list" json:"message_list,omitempty"`
...
type CipherProperties struct {
	...
	MetadataIv []byte `protobuf:"bytes,3,opt,name=metadata_iv" json:"metadata_iv,omitempty"`
	// The key used for the hmac.
	HmacKey []byte `protobuf:"bytes,5,opt,name=hmac_key" json:"hmac_key,omitempty"`
	// The API version of the cipher.
	HmacType         *CipherProperties_HMACType `protobuf:"varint,6,opt,name=hmac_type,enum=CipherProperties_HMACType,def=0" json:"hmac_type,omitempty"`
	XXX_unrecognized []byte                     `json:"-"`
}
...
type ClientCommunication struct {
	...
	EncryptedCipher []byte `protobuf:"bytes,2,opt,name=encrypted_cipher" json:"encrypted_cipher,omitempty"`
	...
	EncryptedCipherMetadata []byte `protobuf:"bytes,9,opt,name=encrypted_cipher_metadata" json:"encrypted_cipher_metadata,omitempty"`
	// This iv is used to encrypt the encrypted field (No. 1). This IV changes for
	// each packet.
	PacketIv    []byte       `protobuf:"bytes,8,opt,name=packet_iv" json:"packet_iv,omitempty"`
	OrigRequest *HttpRequest `protobuf:"bytes,3,opt,name=orig_request" json:"orig_request,omitempty"`
	...
	QueueSize  *uint32                     `protobuf:"varint,4,opt,name=queue_size,def=0" json:"queue_size,omitempty"`
	...
	ApiVersion *uint32                     `protobuf:"varint,6,opt,name=api_version" json:"api_version,omitempty"`
	...
	// 4) The packet iv
	// 5) the api_version.
	FullHmac         []byte `protobuf:"bytes,10,opt,name=full_hmac" json:"full_hmac,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
type GrrStatus struct {
	...
	ErrorMessage     *string                   `protobuf:"bytes,2,opt,name=error_message,def=" json:"error_message,omitempty"`
	Backtrace        *string                   `protobuf:"bytes,3,opt,name=backtrace,def=" json:"backtrace,omitempty"`
	CpuTimeUsed      *CpuSeconds               `protobuf:"bytes,4,opt,name=cpu_time_used" json:"cpu_time_used,omitempty"`
	ChildSessionId   *string                   `protobuf:"bytes,5,opt,name=child_session_id" json:"child_session_id,omitempty"`
	NetworkBytesSent *uint64                   `protobuf:"varint,6,opt,name=network_bytes_sent" json:"network_bytes_sent,omitempty"`
	NannyStatus      *string                   `protobuf:"bytes,7,opt,name=nanny_status" json:"nanny_status,omitempty"`
	XXX_unrecognized []byte                    `json:"-"`
}
...
type GrrNotification struct {
	...
	FirstQueued      *uint64              `protobuf:"varint,3,opt,name=first_queued" json:"first_queued,omitempty"`
	LastStatus       *uint64              `protobuf:"varint,4,opt,name=last_status" json:"last_status,omitempty"`
	InProgress       *bool                `protobuf:"varint,5,opt,name=in_progress,def=0" json:"in_progress,omitempty"`
	Timestamp        *uint64              `protobuf:"varint,6,opt,name=timestamp" json:"timestamp,omitempty"`
	XXX_unrecognized []byte               `json:"-"`
}
...
type ClientCrash struct {
	...
	ClientInfo       *ClientInformation `protobuf:"bytes,3,opt,name=client_info" json:"client_info,omitempty"`
	Timestamp        *uint64            `protobuf:"varint,4,opt,name=timestamp" json:"timestamp,omitempty"`
	CrashType        *string            `protobuf:"bytes,5,opt,name=crash_type" json:"crash_type,omitempty"`
	CrashMessage     *string            `protobuf:"bytes,6,opt,name=crash_message" json:"crash_message,omitempty"`
...
type HuntResultNotification struct {
	ResultCollectionUrn *string `protobuf:"bytes,1,opt,name=result_collection_urn" json:"result_collection_urn,omitempty"`
...
type FlowNotification struct {
	SessionId        *string                  `protobuf:"bytes,1,opt,name=session_id" json:"session_id,omitempty"`
	FlowName         *string                  `protobuf:"bytes,2,opt,name=flow_name" json:"flow_name,omitempty"`
...
type ClientInformation struct {
	ClientName        *string  `protobuf:"bytes,1,opt,name=client_name" json:"client_name,omitempty"`
	...
	BuildTime         *string  `protobuf:"bytes,4,opt,name=build_time" json:"build_time,omitempty"`
	ClientDescription *string  `protobuf:"bytes,5,opt,name=client_description" json:"client_description,omitempty"`
...
type Task struct {
	...
	LastLease        *string              `protobuf:"bytes,7,opt,name=last_lease" json:"last_lease,omitempty"`
	XXX_unrecognized []byte               `json:"-"`
}
...
type DataBlob struct {
	...
	ProtoName *string           `protobuf:"bytes,4,opt,name=proto_name" json:"proto_name,omitempty"`
	...
	RdfValue  *EmbeddedRDFValue `protobuf:"bytes,10,opt,name=rdf_value" json:"rdf_value,omitempty"`
...
type CopyPathToFile struct {
	...
	SrcPath          *PathSpec `protobuf:"bytes,3,opt,name=src_path" json:"src_path,omitempty"`
	DestDir          *string   `protobuf:"bytes,4,opt,name=dest_dir" json:"dest_dir,omitempty"`
	DestPath         *PathSpec `protobuf:"bytes,5,opt,name=dest_path" json:"dest_path,omitempty"`
	GzipOutput       *bool     `protobuf:"varint,6,opt,name=gzip_output,def=1" json:"gzip_output,omitempty"`
...
type RequestState struct {
	...
	TsId      *uint64    `protobuf:"varint,2,opt,name=ts_id" json:"ts_id,omitempty"`
	NextState *string    `protobuf:"bytes,3,opt,name=next_state" json:"next_state,omitempty"`
	...
	ResponseCount *uint32 `protobuf:"varint,6,opt,name=response_count,def=0" json:"response_count,omitempty"`
	// A count of request retransmits
	TransmissionCount *uint32 `protobuf:"varint,7,opt,name=transmission_count,def=0" json:"transmission_count,omitempty"`
	ClientId          *string `protobuf:"bytes,8,opt,name=client_id" json:"client_id,omitempty"`
	SessionId         *string `protobuf:"bytes,9,opt,name=session_id" json:"session_id,omitempty"`
...
type Flow struct {
	...
	TsId      *uint64     `protobuf:"varint,3,opt,name=ts_id" json:"ts_id,omitempty"`
	...
	OutstandingRequests *uint32 `protobuf:"varint,6,opt,name=outstanding_requests,def=0" json:"outstanding_requests,omitempty"`
	...
	CreateTime          *uint64 `protobuf:"varint,9,opt,name=create_time,def=0" json:"create_time,omitempty"`
	...
	RequestState *RequestState `protobuf:"bytes,14,opt,name=request_state" json:"request_state,omitempty"`
	...
	ClientId *string `protobuf:"bytes,17,opt,name=client_id" json:"client_id,omitempty"`
	// The cpu seconds used on the client to complete this flow.
	CpuUsed *CpuSeconds `protobuf:"bytes,18,opt,name=cpu_used" json:"cpu_used,omitempty"`
	// The bandwidth used for this flow.
	NetworkBytesSent *uint64 `protobuf:"varint,19,opt,name=network_bytes_sent" json:"network_bytes_sent,omitempty"`
...
type CpuSeconds struct {
	UserCpuTime      *float32 `protobuf:"fixed32,1,opt,name=user_cpu_time" json:"user_cpu_time,omitempty"`
	SystemCpuTime    *float32 `protobuf:"fixed32,2,opt,name=system_cpu_time" json:"system_cpu_time,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}
...
type CpuSample struct {
	UserCpuTime      *float32 `protobuf:"fixed32,1,opt,name=user_cpu_time" json:"user_cpu_time,omitempty"`
	SystemCpuTime    *float32 `protobuf:"fixed32,2,opt,name=system_cpu_time" json:"system_cpu_time,omitempty"`
	CpuPercent       *float32 `protobuf:"fixed32,3,opt,name=cpu_percent" json:"cpu_percent,omitempty"`
	Timestamp        *uint64  `protobuf:"varint,4,opt,name=timestamp" json:"timestamp,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}
...
type IOSample struct {
	ReadCount        *uint64 `protobuf:"varint,1,opt,name=read_count" json:"read_count,omitempty"`
	WriteCount       *uint64 `protobuf:"varint,2,opt,name=write_count" json:"write_count,omitempty"`
	ReadBytes        *uint64 `protobuf:"varint,3,opt,name=read_bytes" json:"read_bytes,omitempty"`
	WriteBytes       *uint64 `protobuf:"varint,4,opt,name=write_bytes" json:"write_bytes,omitempty"`
...
type ClientStats struct {
	CpuSamples       []*CpuSample `protobuf:"bytes,1,rep,name=cpu_samples" json:"cpu_samples,omitempty"`
	RSSSize          *uint64      `protobuf:"varint,2,opt,name=RSS_size" json:"RSS_size,omitempty"`
	VMSSize          *uint64      `protobuf:"varint,3,opt,name=VMS_size" json:"VMS_size,omitempty"`
	MemoryPercent    *float32     `protobuf:"fixed32,4,opt,name=memory_percent" json:"memory_percent,omitempty"`
	BytesReceived    *uint64      `protobuf:"varint,5,opt,name=bytes_received" json:"bytes_received,omitempty"`
	BytesSent        *uint64      `protobuf:"varint,6,opt,name=bytes_sent" json:"bytes_sent,omitempty"`
	IoSamples        []*IOSample  `protobuf:"bytes,7,rep,name=io_samples" json:"io_samples,omitempty"`
	CreateTime       *uint64      `protobuf:"varint,8,opt,name=create_time" json:"create_time,omitempty"`
	BootTime         *uint64      `protobuf:"varint,9,opt,name=boot_time" json:"boot_time,omitempty"`
	XXX_unrecognized []byte       `json:"-"`
}
...
type StartupInfo struct {
	ClientInfo       *ClientInformation `protobuf:"bytes,1,opt,name=client_info" json:"client_info,omitempty"`
	BootTime         *uint64            `protobuf:"varint,2,opt,name=boot_time" json:"boot_time,omitempty"`
	XXX_unrecognized []byte             `json:"-"`
}
...
type ExecuteRequest struct {
	...
	TimeLimit        *int32 `protobuf:"varint,3,opt,name=time_limit" json:"time_limit,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
type ExecuteResponse struct {
	...
	ExitStatus *int32          `protobuf:"varint,2,opt,name=exit_status" json:"exit_status,omitempty"`
	...
	TimeUsed         *int32 `protobuf:"varint,5,opt,name=time_used" json:"time_used,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
type PathSpec struct {
	...
	MountPoint *string            `protobuf:"bytes,3,opt,name=mount_point" json:"mount_point,omitempty"`
	StreamName *string            `protobuf:"bytes,11,opt,name=stream_name" json:"stream_name,omitempty"`
	NestedPath *PathSpec          `protobuf:"bytes,5,opt,name=nested_path" json:"nested_path,omitempty"`
	// Offset for split images
	Offset         *uint64           `protobuf:"varint,6,opt,name=offset" json:"offset,omitempty"`
	PathOptions    *PathSpec_Options `protobuf:"varint,7,opt,name=path_options,enum=PathSpec_Options,def=0" json:"path_options,omitempty"`
	RecursionDepth *uint64           `protobuf:"varint,12,opt,name=recursion_depth,def=3" json:"recursion_depth,omitempty"`
	...
	NtfsType         *PathSpecTskFsAttrType `protobuf:"varint,9,opt,name=ntfs_type,enum=PathSpecTskFsAttrType,def=1" json:"ntfs_type,omitempty"`
	NtfsId           *uint64                `protobuf:"varint,10,opt,name=ntfs_id" json:"ntfs_id,omitempty"`
	FileSizeOverride *uint64                `protobuf:"varint,13,opt,name=file_size_override,def=512000" json:"file_size_override,omitempty"`
	IsVirtualroot    *bool                  `protobuf:"varint,14,opt,name=is_virtualroot" json:"is_virtualroot,omitempty"`
	XXX_unrecognized []byte                 `json:"-"`
}
...
type StatEntry struct {
	...
	StMode       *uint64                 `protobuf:"varint,2,opt,name=st_mode,def=0" json:"st_mode,omitempty"`
	StIno        *uint32                 `protobuf:"varint,3,opt,name=st_ino" json:"st_ino,omitempty"`
	StDev        *uint32                 `protobuf:"varint,4,opt,name=st_dev" json:"st_dev,omitempty"`
	StNlink      *uint32                 `protobuf:"varint,5,opt,name=st_nlink" json:"st_nlink,omitempty"`
	StUid        *uint32                 `protobuf:"varint,6,opt,name=st_uid" json:"st_uid,omitempty"`
	StGid        *uint32                 `protobuf:"varint,7,opt,name=st_gid" json:"st_gid,omitempty"`
	StSize       *uint64                 `protobuf:"varint,8,opt,name=st_size" json:"st_size,omitempty"`
	StAtime      *uint64                 `protobuf:"varint,9,opt,name=st_atime" json:"st_atime,omitempty"`
	StMtime      *uint64                 `protobuf:"varint,10,opt,name=st_mtime" json:"st_mtime,omitempty"`
	StCtime      *uint64                 `protobuf:"varint,11,opt,name=st_ctime" json:"st_ctime,omitempty"`
	StBlocks     *uint32                 `protobuf:"varint,12,opt,name=st_blocks" json:"st_blocks,omitempty"`
	StBlksize    *uint32                 `protobuf:"varint,13,opt,name=st_blksize" json:"st_blksize,omitempty"`
	StRdev       *uint32                 `protobuf:"varint,14,opt,name=st_rdev" json:"st_rdev,omitempty"`
	Symlink      *string                 `protobuf:"bytes,15,opt,name=symlink" json:"symlink,omitempty"`
	RegistryType *StatEntry_RegistryType `protobuf:"varint,16,opt,name=registry_type,enum=StatEntry_RegistryType" json:"registry_type,omitempty"`
	...
	RegistryData     *DataBlob `protobuf:"bytes,19,opt,name=registry_data" json:"registry_data,omitempty"`
	StCrtime         *uint64   `protobuf:"varint,20,opt,name=st_crtime" json:"st_crtime,omitempty"`
	XXX_unrecognized []byte    `json:"-"`
}
...
type WmiRequest struct {
	...
	BaseObject       *string `protobuf:"bytes,2,opt,name=base_object" json:"base_object,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type Uname struct {
	...
	InstallDate      *uint64 `protobuf:"varint,8,opt,name=install_date" json:"install_date,omitempty"`
	LibcVer          *string `protobuf:"bytes,9,opt,name=libc_ver" json:"libc_ver,omitempty"`
...
type FolderInformation struct {
	AppData      *string `protobuf:"bytes,1,opt,name=app_data" json:"app_data,omitempty"`
	...
	LocalAppData *string `protobuf:"bytes,7,opt,name=local_app_data" json:"local_app_data,omitempty"`
	// ID 8 previously used by local_settings
	MyMusic          *string `protobuf:"bytes,9,opt,name=my_music" json:"my_music,omitempty"`
	MyPictures       *string `protobuf:"bytes,10,opt,name=my_pictures" json:"my_pictures,omitempty"`
	MyVideo          *string `protobuf:"bytes,11,opt,name=my_video" json:"my_video,omitempty"`
	NetHood          *string `protobuf:"bytes,12,opt,name=net_hood" json:"net_hood,omitempty"`
	Personal         *string `protobuf:"bytes,13,opt,name=personal" json:"personal,omitempty"`
	PrintHood        *string `protobuf:"bytes,14,opt,name=print_hood" json:"print_hood,omitempty"`
	...
	SendTo           *string `protobuf:"bytes,17,opt,name=send_to" json:"send_to,omitempty"`
	StartMenu        *string `protobuf:"bytes,18,opt,name=start_menu" json:"start_menu,omitempty"`
...
type NetworkAddress struct {
	AddressType      *NetworkAddress_Family `protobuf:"varint,1,opt,name=address_type,enum=NetworkAddress_Family" json:"address_type,omitempty"`
	HumanReadable    *string                `protobuf:"bytes,2,opt,name=human_readable" json:"human_readable,omitempty"`
	PackedBytes      []byte                 `protobuf:"bytes,3,opt,name=packed_bytes" json:"packed_bytes,omitempty"`
	XXX_unrecognized []byte                 `json:"-"`
}
...
type Interface struct {
	// CyBOX: mac
	MacAddress []byte `protobuf:"bytes,1,opt,name=mac_address" json:"mac_address,omitempty"`
	// ip4_addresses is deprecated, use addresses.
	Ip4Addresses [][]byte `protobuf:"bytes,2,rep,name=ip4_addresses" json:"ip4_addresses,omitempty"`
	// CyBOX: adapter
	Ifname *string `protobuf:"bytes,3,opt,name=ifname" json:"ifname,omitempty"`
	// ip6_addresses is deprecated, use addresses.
	Ip6Addresses [][]byte `protobuf:"bytes,4,rep,name=ip6_addresses" json:"ip6_addresses,omitempty"`
	// CyBOX: ip_list
	Addresses         []*NetworkAddress `protobuf:"bytes,5,rep,name=addresses" json:"addresses,omitempty"`
	DhcpLeaseExpires  *uint64           `protobuf:"varint,6,opt,name=dhcp_lease_expires" json:"dhcp_lease_expires,omitempty"`
	DhcpLeaseObtained *uint64           `protobuf:"varint,7,opt,name=dhcp_lease_obtained" json:"dhcp_lease_obtained,omitempty"`
	DhcpServerList    []*NetworkAddress `protobuf:"bytes,8,rep,name=dhcp_server_list" json:"dhcp_server_list,omitempty"`
	IpGatewayList     []*NetworkAddress `protobuf:"bytes,9,rep,name=ip_gateway_list" json:"ip_gateway_list,omitempty"`
	XXX_unrecognized  []byte            `json:"-"`
}
...
type Hash struct {
	...
	PecoffSha1       []byte                    `protobuf:"bytes,4,opt,name=pecoff_sha1" json:"pecoff_sha1,omitempty"`
	PecoffMd5        []byte                    `protobuf:"bytes,5,opt,name=pecoff_md5" json:"pecoff_md5,omitempty"`
	PecoffSha256     []byte                    `protobuf:"bytes,7,opt,name=pecoff_sha256" json:"pecoff_sha256,omitempty"`
	SignedData       []*AuthenticodeSignedData `protobuf:"bytes,6,rep,name=signed_data" json:"signed_data,omitempty"`
	XXX_unrecognized []byte                    `json:"-"`
}
...
type AuthenticodeSignedData struct {
	...
	CertType         *uint64 `protobuf:"varint,2,opt,name=cert_type" json:"cert_type,omitempty"`
...
type FingerprintTuple struct {
	FpType           *FingerprintTuple_Type      `protobuf:"varint,1,req,name=fp_type,enum=FingerprintTuple_Type" json:"fp_type,omitempty"`
...
type FingerprintRequest struct {
	...
	MaxFilesize      *uint64             `protobuf:"varint,3,opt,name=max_filesize,def=10737418240" json:"max_filesize,omitempty"`
	XXX_unrecognized []byte              `json:"-"`
}
...
type FingerprintResponse struct {
	MatchingTypes []FingerprintTuple_Type `protobuf:"varint,1,rep,name=matching_types,enum=FingerprintTuple_Type" json:"matching_types,omitempty"`
	...
	BytesRead        *uint64   `protobuf:"varint,5,opt,name=bytes_read" json:"bytes_read,omitempty"`
	XXX_unrecognized []byte    `json:"-"`
}
...
type SignedBlob struct {
	...
	DigestType       *SignedBlob_HashType      `protobuf:"varint,3,opt,name=digest_type,enum=SignedBlob_HashType" json:"digest_type,omitempty"`
	Signature        []byte                    `protobuf:"bytes,4,opt,name=signature" json:"signature,omitempty"`
	SignatureType    *SignedBlob_SignatureType `protobuf:"varint,5,opt,name=signature_type,enum=SignedBlob_SignatureType" json:"signature_type,omitempty"`
	XXX_unrecognized []byte                    `json:"-"`
}
...
type SymmetricCipher struct {
	XAlgorithm       *SymmetricCipher_Algorithm `protobuf:"varint,1,opt,name=_algorithm,enum=SymmetricCipher_Algorithm" json:"_algorithm,omitempty"`
	XKey             []byte                     `protobuf:"bytes,2,opt,name=_key" json:"_key,omitempty"`
	XIv              []byte                     `protobuf:"bytes,3,opt,name=_iv" json:"_iv,omitempty"`
	XXX_unrecognized []byte                     `json:"-"`
}
...
type ExecutePythonRequest struct {
	PythonCode       *SignedBlob `protobuf:"bytes,1,opt,name=python_code" json:"python_code,omitempty"`
...
type ExecutePythonResponse struct {
	ReturnVal        []byte `protobuf:"bytes,1,opt,name=return_val" json:"return_val,omitempty"`
	TimeUsed         *int32 `protobuf:"varint,2,opt,name=time_used" json:"time_used,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
type ClientComponent struct {
	...
	RawData          []byte                  `protobuf:"bytes,2,opt,name=raw_data" json:"raw_data,omitempty"`
	BuildSystem      *Uname                  `protobuf:"bytes,3,opt,name=build_system" json:"build_system,omitempty"`
	XXX_unrecognized []byte                  `json:"-"`
}
...
type ExecuteBinaryRequest struct {
	...
	WritePath  *string     `protobuf:"bytes,2,opt,name=write_path" json:"write_path,omitempty"`
	Args       []string    `protobuf:"bytes,3,rep,name=args" json:"args,omitempty"`
	// An execution time limit, given in seconds.
	TimeLimit        *int32 `protobuf:"varint,4,opt,name=time_limit" json:"time_limit,omitempty"`
	MoreData         *bool  `protobuf:"varint,5,opt,name=more_data" json:"more_data,omitempty"`
	Offset           *int64 `protobuf:"varint,6,opt,name=offset" json:"offset,omitempty"`
	UseClientEnv     *bool  `protobuf:"varint,7,opt,name=use_client_env,def=0" json:"use_client_env,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
type ExecuteBinaryResponse struct {
	...
	// The time used to execute the cmd, given in microseconds.
	TimeUsed         *int32 `protobuf:"varint,4,opt,name=time_used" json:"time_used,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
type DriverInstallTemplate struct {
	...
	WritePath   *string     `protobuf:"bytes,2,opt,name=write_path" json:"write_path,omitempty"`
	ForceReload *uint32     `protobuf:"varint,3,opt,name=force_reload" json:"force_reload,omitempty"`
	// Windows specific options.
	DriverName        *string                            `protobuf:"bytes,6,opt,name=driver_name" json:"driver_name,omitempty"`
	DriverDisplayName *string                            `protobuf:"bytes,7,opt,name=driver_display_name" json:"driver_display_name,omitempty"`
	DevicePath        *string                            `protobuf:"bytes,8,opt,name=device_path" json:"device_path,omitempty"`
...
type SendFileRequest struct {
	Pathspec         *PathSpec              `protobuf:"bytes,1,opt,name=pathspec" json:"pathspec,omitempty"`
	AddressFamily    *NetworkAddress_Family `protobuf:"varint,2,opt,name=address_family,enum=NetworkAddress_Family,def=0" json:"address_family,omitempty"`
...
type FindSpec struct {
	...
	PathGlob  *string   `protobuf:"bytes,13,opt,name=path_glob" json:"path_glob,omitempty"`
	PathRegex *string   `protobuf:"bytes,3,opt,name=path_regex" json:"path_regex,omitempty"`
	DataRegex *string   `protobuf:"bytes,4,opt,name=data_regex" json:"data_regex,omitempty"`
	StartTime *uint64   `protobuf:"varint,5,opt,name=start_time,def=0" json:"start_time,omitempty"`
	EndTime   *uint64   `protobuf:"varint,6,opt,name=end_time,def=9223372036854775807" json:"end_time,omitempty"`
	// Should we cross filesystems? Default is no.
	CrossDevs *bool `protobuf:"varint,7,opt,name=cross_devs,def=0" json:"cross_devs,omitempty"`
	// How deep to search?
	MaxDepth *int32     `protobuf:"varint,8,opt,name=max_depth,def=15" json:"max_depth,omitempty"`
	...
	MaxData          *uint64 `protobuf:"varint,10,opt,name=max_data,def=1024000" json:"max_data,omitempty"`
	MinFileSize      *uint64 `protobuf:"varint,11,opt,name=min_file_size,def=0" json:"min_file_size,omitempty"`
	MaxFileSize      *uint64 `protobuf:"varint,12,opt,name=max_file_size,def=9223372036854775807" json:"max_file_size,omitempty"`
	PermMask         *uint64 `protobuf:"varint,14,opt,name=perm_mask,def=4095" json:"perm_mask,omitempty"`
	PermMode         *uint64 `protobuf:"varint,15,opt,name=perm_mode" json:"perm_mode,omitempty"`
...
type ForemanClientRuleSet struct {
	...
	MatchMode        *ForemanClientRuleSet_MatchMode `protobuf:"varint,1,opt,name=match_mode,enum=ForemanClientRuleSet_MatchMode,def=0" json:"match_mode,omitempty"`
...
type ForemanClientRule struct {
	RuleType         *ForemanClientRule_Type   `protobuf:"varint,1,opt,name=rule_type,enum=ForemanClientRule_Type" json:"rule_type,omitempty"`
...
type ForemanOsClientRule struct {
	OsWindows        *bool  `protobuf:"varint,1,opt,name=os_windows" json:"os_windows,omitempty"`
	OsLinux          *bool  `protobuf:"varint,2,opt,name=os_linux" json:"os_linux,omitempty"`
	OsDarwin         *bool  `protobuf:"varint,3,opt,name=os_darwin" json:"os_darwin,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
type ForemanLabelClientRule struct {
	LabelNames       []string                          `protobuf:"bytes,1,rep,name=label_names" json:"label_names,omitempty"`
	MatchMode        *ForemanLabelClientRule_MatchMode `protobuf:"varint,2,opt,name=match_mode,enum=ForemanLabelClientRule_MatchMode,def=0" json:"match_mode,omitempty"`
	XXX_unrecognized []byte                            `json:"-"`
}
...
type ForemanRegexClientRule struct {
	...
	AttributeName    *string `protobuf:"bytes,2,opt,name=attribute_name" json:"attribute_name,omitempty"`
	AttributeRegex   *string `protobuf:"bytes,3,opt,name=attribute_regex" json:"attribute_regex,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type ForemanRuleAction struct {
	FlowName *string `protobuf:"bytes,1,opt,name=flow_name" json:"flow_name,omitempty"`
	Argv     *Dict   `protobuf:"bytes,2,opt,name=argv" json:"argv,omitempty"`
	// Hunts are handled specially here.
	HuntName *string `protobuf:"bytes,3,opt,name=hunt_name" json:"hunt_name,omitempty"`
	// Hunt session id.
	HuntId           *string `protobuf:"bytes,4,opt,name=hunt_id" json:"hunt_id,omitempty"`
	ClientLimit      *uint64 `protobuf:"varint,5,opt,name=client_limit" json:"client_limit,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type ForemanRule struct {
	...
	ClientRuleSet *ForemanClientRuleSet `protobuf:"bytes,7,opt,name=client_rule_set" json:"client_rule_set,omitempty"`
...
type FlowLog struct {
	...
	FlowName         *string `protobuf:"bytes,4,opt,name=flow_name" json:"flow_name,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type ClientResources struct {
	ClientId         *string     `protobuf:"bytes,1,opt,name=client_id" json:"client_id,omitempty"`
	SessionId        *string     `protobuf:"bytes,2,opt,name=session_id" json:"session_id,omitempty"`
	CpuUsage         *CpuSeconds `protobuf:"bytes,3,opt,name=cpu_usage" json:"cpu_usage,omitempty"`
	NetworkBytesSent *uint64     `protobuf:"varint,4,opt,name=network_bytes_sent" json:"network_bytes_sent,omitempty"`
	XXX_unrecognized []byte      `json:"-"`
}
...
type StatsHistogramBin struct {
	RangeMaxValue    *float32 `protobuf:"fixed32,1,opt,name=range_max_value" json:"range_max_value,omitempty"`
...
type RunningStats struct {
	...
	SumSq            *float64        `protobuf:"fixed64,4,opt,name=sum_sq" json:"sum_sq,omitempty"`
	XXX_unrecognized []byte          `json:"-"`
}
...
type ClientResourcesStats struct {
	UserCpuStats          *RunningStats      `protobuf:"bytes,1,opt,name=user_cpu_stats" json:"user_cpu_stats,omitempty"`
	SystemCpuStats        *RunningStats      `protobuf:"bytes,2,opt,name=system_cpu_stats" json:"system_cpu_stats,omitempty"`
	NetworkBytesSentStats *RunningStats      `protobuf:"bytes,3,opt,name=network_bytes_sent_stats" json:"network_bytes_sent_stats,omitempty"`
	WorstPerformers       []*ClientResources `protobuf:"bytes,4,rep,name=worst_performers" json:"worst_performers,omitempty"`
	XXX_unrecognized      []byte             `json:"-"`
}
...
type Iterator struct {
	...
	ClientState *Dict `protobuf:"bytes,1,opt,name=client_state" json:"client_state,omitempty"`
	...
	SuspendedAction  *uint64         `protobuf:"varint,5,opt,name=suspended_action" json:"suspended_action,omitempty"`
	XXX_unrecognized []byte          `json:"-"`
}
...
type GlobalNotification struct {
	...
	ShowFrom         *uint64                  `protobuf:"varint,5,opt,name=show_from" json:"show_from,omitempty"`
...
type EmbeddedRDFValue struct {
	EmbeddedAge *uint64 `protobuf:"varint,1,opt,name=embedded_age" json:"embedded_age,omitempty"`
...
type ClientSummary struct {
	ClientId           *string            `protobuf:"bytes,1,opt,name=client_id" json:"client_id,omitempty"`
	Timestamp          *uint64            `protobuf:"varint,2,opt,name=timestamp" json:"timestamp,omitempty"`
	SystemInfo         *Uname             `protobuf:"bytes,3,opt,name=system_info" json:"system_info,omitempty"`
	ClientInfo         *ClientInformation `protobuf:"bytes,4,opt,name=client_info" json:"client_info,omitempty"`
	InstallDate        *uint64            `protobuf:"varint,5,opt,name=install_date" json:"install_date,omitempty"`
	Interfaces         []*Interface       `protobuf:"bytes,7,rep,name=interfaces" json:"interfaces,omitempty"`
	SerialNumber       *string            `protobuf:"bytes,8,opt,name=serial_number" json:"serial_number,omitempty"`
	SystemManufacturer *string            `protobuf:"bytes,9,opt,name=system_manufacturer" json:"system_manufacturer,omitempty"`
...
type MetricFieldDefinition struct {
	...
	FieldType        *MetricFieldDefinition_FieldType `protobuf:"varint,2,opt,name=field_type,enum=MetricFieldDefinition_FieldType" json:"field_type,omitempty"`
	XXX_unrecognized []byte                           `json:"-"`
}
...
type MetricMetadata struct {
	...
	MetricType       *MetricMetadata_MetricType  `protobuf:"varint,2,opt,name=metric_type,enum=MetricMetadata_MetricType" json:"metric_type,omitempty"`
	ValueType        *MetricMetadata_ValueType   `protobuf:"varint,3,opt,name=value_type,enum=MetricMetadata_ValueType" json:"value_type,omitempty"`
	FieldsDefs       []*MetricFieldDefinition    `protobuf:"bytes,4,rep,name=fields_defs" json:"fields_defs,omitempty"`
...
type Distribution struct {
	...
	BinsHeights      []float32 `protobuf:"fixed32,4,rep,name=bins_heights" json:"bins_heights,omitempty"`
	XXX_unrecognized []byte    `json:"-"`
}
...
type StatsStoreFieldValue struct {
	FieldType        *MetricFieldDefinition_FieldType `protobuf:"varint,1,opt,name=field_type,enum=MetricFieldDefinition_FieldType" json:"field_type,omitempty"`
	StrValue         *string                          `protobuf:"bytes,2,opt,name=str_value" json:"str_value,omitempty"`
...
type StatsStoreValue struct {
	ValueType         *MetricMetadata_ValueType `protobuf:"varint,1,opt,name=value_type,enum=MetricMetadata_ValueType" json:"value_type,omitempty"`
	StrValue          *string                   `protobuf:"bytes,2,opt,name=str_value" json:"str_value,omitempty"`
	IntValue          *int64                    `protobuf:"varint,3,opt,name=int_value" json:"int_value,omitempty"`
	FloatValue        *float32                  `protobuf:"fixed32,4,opt,name=float_value" json:"float_value,omitempty"`
	DistributionValue *Distribution             `protobuf:"bytes,5,opt,name=distribution_value" json:"distribution_value,omitempty"`
	FieldsValues      []*StatsStoreFieldValue   `protobuf:"bytes,6,rep,name=fields_values" json:"fields_values,omitempty"`
	XXX_unrecognized  []byte                    `json:"-"`
}
...
type SeekIndexPair struct {
	IndexOffset      *uint64 `protobuf:"varint,1,opt,name=index_offset" json:"index_offset,omitempty"`
	ByteOffset       *uint64 `protobuf:"varint,2,opt,name=byte_offset" json:"byte_offset,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type PersistenceFile struct {
	Pathspec         *PathSpec `protobuf:"bytes,1,opt,name=pathspec" json:"pathspec,omitempty"`
	SourceUrn        *string   `protobuf:"bytes,2,opt,name=source_urn" json:"source_urn,omitempty"`
	XXX_unrecognized []byte    `json:"-"`
}
...
type EndToEndTestResult struct {
	...
	TestClassName    *string `protobuf:"bytes,2,opt,name=test_class_name" json:"test_class_name,omitempty"`
	Timestamp        *uint64 `protobuf:"varint,3,opt,name=timestamp" json:"timestamp,omitempty"`
...
type NSRLInformation struct {
	...
	ProductCode      []uint64                  `protobuf:"varint,6,rep,name=product_code" json:"product_code,omitempty"`
	OpSystemCode     []string                  `protobuf:"bytes,7,rep,name=op_system_code" json:"op_system_code,omitempty"`
	FileType         *NSRLInformation_FileType `protobuf:"varint,8,opt,name=file_type,enum=NSRLInformation_FileType" json:"file_type,omitempty"`
	XXX_unrecognized []byte                    `json:"-"`
}
...
var fileDescriptor11 = []byte{
	// 12954 bytes of a gzipped FileDescriptorProto
	,
}
